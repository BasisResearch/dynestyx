...
- [handlers](api_reference/handlers.md) - Context handlers and condition management
...
- [ops](api_reference/ops.md) - Core operations and data structures
- [plotters](api_reference/plotters.md) - Plotting utilities
