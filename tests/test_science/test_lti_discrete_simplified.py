...
def test_mcmc_inference(
    data_conditioned_discrete_time_lti_simplified_science,  # noqa: F811
    num_samples,
):
    """LTI_discrete: run exact KF and PF, check posterior recovers true alpha."""
    (
        ...
        use_controls,
        filter_type,
    ) = data_conditioned_discrete_time_lti_simplified_science
